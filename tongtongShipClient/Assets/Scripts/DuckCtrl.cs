...
public class DuckCtrl : MonoBehaviour
{
    ...
    private float controlOverBoat = 24f;  // With higher values, the boat follows your command better
    ...
    private float[] controlOverBoatList = { 18f, 20f, 24f, 28f, 33f, 36f, 39f, 42f, 45f, 48f, 52f };
